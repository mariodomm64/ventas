                                ...
                                <div class="table-responsive">
                                    <table class="table style--2">
                                        ...
                                        <tbody>
                                            <!-- Table Row Start -->
                                            <tr>
                                                <td><img src="<?=base_url()?>assets/img/products/thumb-01.jpg" alt=""></td>
                                                <td>3BSD59</td>
                                            ...
                                            <!-- Table Row Start -->
                                            <tr>
                                                <td><img src="<?=base_url()?>assets/img/products/thumb-02.jpg" alt=""></td>
                                                <td>3BSD59</td>
                                                <td><a href="#" class="btn-link">Leisure Suit Casual</a></td>
                                                <td>$99</td>
                                                <td>2</td>
                                            ...
                                            <!-- Table Row Start -->
                                            <tr>
                                                <td><img src="<?=base_url()?>assets/img/products/thumb-03.jpg" alt=""></td>
                                                <td>3BSD59</td>
                                                <td><a href="#" class="btn-link">Leisure Suit Casual</a></td>
                                                <td>$99</td>
                                                <td>2</td>
