...
<div class="sidebar--profile">
    <div class="profile--img">
        <a href="profile.html">
            <img src="<?=base_url()?>assets/img/avatars/01_80x80.png" alt="" class="rounded-circle">
        </a>
    </div>

    <div class="profile--name">
        <a href="profile.html" class="btn-link">Administrador</a>
    </div>
        ...
        <li>
            <ul>
                ...
                <li class="active open">
                    ...
                    <ul>
                        <li class="active"><a href="ecommerce.html">Clientes</a></li>
